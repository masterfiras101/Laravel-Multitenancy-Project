        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 sticky items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Laravel Multitenancy</h2>
                    ...
                    <footer class="py-16 text-center text-xl text-black dark:text-white/70">
                        masterfiras101  (Laravel 11  & PHP 8.2.12 )Versions
                    </footer>
                </div>
            </div>
        </div>
